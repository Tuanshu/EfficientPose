...
def extract_coordinates(frame_output, frame_height, frame_width, real_time=False):
    ...
    body_parts = ['head_top', 'upper_neck', 'right_shoulder', 'right_elbow', 'right_wrist', 'thorax', 'left_shoulder',
                  'left_elbow', 'left_wrist', 'pelvis', 'right_hip', 'right_knee', 'right_ankle', 'left_hip', 'left_knee', 'left_ankle']
...
def display_body_parts(image, image_draw, coordinates, image_height=1024, image_width=1024, marker_radius=5):
    ...
    body_part_colors = ['#fff142', '#fff142', '#576ab1', '#5883c4', '#56bdef', '#f19718', '#d33592',
    ...
    for i, (body_part, body_part_x, body_part_y) in enumerate(coordinates):
        ...
        image_draw.ellipse([(body_part_x - marker_radius, body_part_y - marker_radius),
                           (body_part_x + marker_radius, body_part_y + marker_radius)], fill=body_part_colors[i])
...
def display_segments(image, image_draw, coordinates, image_height=1024, image_width=1024, segment_width=5):
    ...
    segments = [(0, 1), (1, 5), (5, 2), (5, 6), (5, 9), (2, 3), (3, 4), (6, 7),
                (7, 8), (9, 10), (9, 13), (10, 11), (11, 12), (13, 14), (14, 15)]
    ...
    for (body_part_a_index, body_part_b_index) in segments:
        ...
        image_draw.line([(body_part_a_x, body_part_a_y), (body_part_b_x, body_part_b_y)],
                        fill=segment_colors[body_part_b_index], width=segment_width)
...
def display_camera(cv2, frame, coordinates, frame_height, frame_width):
    ...
    segments = [(0, 1), (1, 5), (5, 2), (5, 6), (5, 9), (2, 3), (3, 4), (6, 7),
                (7, 8), (9, 10), (9, 13), (10, 11), (11, 12), (13, 14), (14, 15)]
    body_part_colors = [(66, 241, 255), (66, 241, 255), (177, 106, 87), (196, 131, 88), (239, 189, 86), (24, 151, 241), (146, 53, 211), (166, 98, 217),
                        (189, 138, 225), (24, 151, 241), (145, 198, 138), (145, 208, 163), (143, 219, 190), (183, 118, 123), (184, 122, 144), (185, 127, 169)]
    ...
    for (a, b) in segments:
        ...
        if not (a_coordinate_x < 0 or a_coordinate_y < 0 or b_coordinate_x < 0 or b_coordinate_y < 0):
            cv2.line(frame, (a_coordinate_x, a_coordinate_y), (b_coordinate_x,
                     b_coordinate_y), color=body_part_colors[a], thickness=2)

            if a in remaining:
                cv2.circle(frame, (a_coordinate_x, a_coordinate_y),
                           radius=3, color=body_part_colors[a], thickness=2)
                remaining.remove(a)
            if b in remaining:
                cv2.circle(frame, (b_coordinate_x, b_coordinate_y),
                           radius=3, color=body_part_colors[b], thickness=2)
                remaining.remove(b)
